...
All notable changes to Tamp.AzureStaticWebApps are documented in this file.
...
- Object-init overloads on every SWA wrapper (TAM-161 satellite fanout).

[0.1.1]: https://github.com/tamp-build/tamp-azure-static-web-apps/releases/tag/v0.1.1
