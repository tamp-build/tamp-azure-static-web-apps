...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-azure-static-web-apps";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need `swa` on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AzureStaticWebApps.V2.Tests" / "Tamp.AzureStaticWebApps.V2.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AzureStaticWebApps.V2" / "Tamp.AzureStaticWebApps.V2.csproj");
